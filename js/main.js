...
document.querySelector(".menu-btn").addEventListener("click", function() {
  // This toggleClass is for added 'menu--open' to our menu HTML element.
  //This will open the menu.
  toggleClass(document.querySelector(".menu"), "menu--open");

  // This toggleClass is for adding '.menu-btn--on' to our menu button HTML element.
  //This creates the animation of the hamburger/hotdog icon to the close icon.
